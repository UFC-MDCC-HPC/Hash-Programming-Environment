...
namespace br.ufc.mdcc.hpcshelf.core
{
    public class CoreServices : ICoreServices
    {
        ...
        private RootPlatformServices platform_SAFe;

        public int openWorkflowSession (string arch_desc_xml, RootPlatformServices platform_SAFe)
        {
        ...
        public int openWorkflowSession (string arch_desc_xml)
        {
            ...
            SAFeSWL_Architecture arch_desc = CoreServicesUtils.readArchitecture (arch_desc_xml);
        ...
        private void tryCreateSystem(int workflow_handle)
        {
            if (delayed_contracts [workflow_handle].Count == 0) 
            {
                ...
                system = CoreServicesUtils.createSystem (active_workflows[workflow_handle], workflow_contract[workflow_handle], unit_mapping, ref platforms);
        ...
        )   
        {
            ...
            bool is_platform = CoreServicesUtils.checkIsPlatform (arch_desc, arch_ref);
            ...
            {   
                ...
                else 
                {
                    ...
                    result = ((RootPlatformServices)platform_SAFe).Address;
                    ...
                    Thread t = new Thread(new ParameterizedThreadStart(delegate (object o)
                        {
                            ...
                            {
                                CoreCacheServices.PlatformServices.PlatformServices platform_access = new CoreCacheServices.PlatformServices.PlatformServices(platform_address);
                                      ...
                                      int workflow_handle)
        {
            ...
            string[] config = CoreServicesUtils.fetchPlatformConfiguration (component_ref);
            ...
            // criar a plataforma
            Tuple<string,int,int> platform_address = CoreServicesUtils.invokeBackEndDeploy (arch_ref, backend_address, config);
                                              ...
                                              IDictionary<string,string> platform_address_list)
        {
            try 
            {
                ...
                for (int facet_instance = 0; facet_instance < platform_placement.Length; facet_instance++) 
                {
                    ...
                    CoreServicesUtils.invokeDeployComponent (platform_address, config_contents);
                }
            }
            catch (Exception e) 
            {
        ...
        {           
            ...
            { 
                ...
                bool is_platform = CoreServicesUtils.checkIsPlatform (arch_desc, platform_ref);
                if (is_platform)
                {
