...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>NAnt Source Control Tasks Cvs Task</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getFileset <em>Fileset</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getArg <em>Arg</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getCommand <em>Command</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getCommandline <em>Commandline</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getCompressionlevel <em>Compressionlevel</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getCvsfullpath <em>Cvsfullpath</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getCvsroot <em>Cvsroot</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getCvsrsh <em>Cvsrsh</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getFailonerror <em>Failonerror</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getIf <em>If</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getModule <em>Module</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getPassfile <em>Passfile</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getQuiet <em>Quiet</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getReadonly <em>Readonly</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getReadwrite <em>Readwrite</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getReallyquiet <em>Reallyquiet</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getTimeout <em>Timeout</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getUnless <em>Unless</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getUsesharpcvslib <em>Usesharpcvslib</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getVerbose <em>Verbose</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksCvsTaskImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NAntSourceControlTasksCvsTaskImpl extends EObjectImpl implements NAntSourceControlTasksCvsTask {
	/**
	 ...
	 * @generated
	 */
	protected NAntSourceControlTasksCvsTaskImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return NantPackage.eINSTANCE.getNAntSourceControlTasksCvsTask();
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__GROUP);
		}
		return group;
	}
	...
	public EList<NAntSourceControlTypesCvsFileSet> getFileset() {
		return getGroup().list(NantPackage.eINSTANCE.getNAntSourceControlTasksCvsTask_Fileset());
	}
	...
	public EList<NAntCoreTypesArgument> getArg() {
		return getGroup().list(NantPackage.eINSTANCE.getNAntSourceControlTasksCvsTask_Arg());
	}
	...
	public void setCommand(Object newCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__COMMAND, oldCommand, command));
	}
	...
	public void setCommandline(Object newCommandline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__COMMANDLINE, oldCommandline, commandline));
	}
	...
	public void setCompressionlevel(Object newCompressionlevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__COMPRESSIONLEVEL, oldCompressionlevel, compressionlevel));
	}
	...
	public void setCvsfullpath(Object newCvsfullpath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__CVSFULLPATH, oldCvsfullpath, cvsfullpath));
	}
	...
	public void setCvsroot(Object newCvsroot) {
		...
		cvsroot = newCvsroot;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__CVSROOT, oldCvsroot, cvsroot));
	}
	...
	public void setCvsrsh(Object newCvsrsh) {
		...
		cvsrsh = newCvsrsh;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__CVSRSH, oldCvsrsh, cvsrsh));
	}
	...
	public void setDestination(Object newDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__DESTINATION, oldDestination, destination));
	}
	...
	public void setFailonerror(Object newFailonerror) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__FAILONERROR, oldFailonerror, failonerror));
	}
	...
	public void setIf(Object newIf) {
		...
		if_ = newIf;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__IF, oldIf, if_));
	}
	...
	public void setModule(Object newModule) {
		...
		module = newModule;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__MODULE, oldModule, module));
	}
	...
	public void setPassfile(Object newPassfile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__PASSFILE, oldPassfile, passfile));
	}
	...
	public void setPassword(Object newPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__PASSWORD, oldPassword, password));
	}
	...
	public void setQuiet(Object newQuiet) {
		...
		quiet = newQuiet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__QUIET, oldQuiet, quiet));
	}
	...
	public void setReadonly(Object newReadonly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__READONLY, oldReadonly, readonly));
	}
	...
	public void setReadwrite(Object newReadwrite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__READWRITE, oldReadwrite, readwrite));
	}
	...
	public void setReallyquiet(Object newReallyquiet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__REALLYQUIET, oldReallyquiet, reallyquiet));
	}
	...
	public void setTimeout(Object newTimeout) {
		...
		timeout = newTimeout;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__TIMEOUT, oldTimeout, timeout));
	}
	...
	public void setUnless(Object newUnless) {
		...
		unless = newUnless;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__UNLESS, oldUnless, unless));
	}
	...
	public void setUsesharpcvslib(Object newUsesharpcvslib) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__USESHARPCVSLIB, oldUsesharpcvslib, usesharpcvslib));
	}
	...
	public void setVerbose(Object newVerbose) {
		...
		verbose = newVerbose;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__VERBOSE, oldVerbose, verbose));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__FILESET:
				return ((InternalEList<?>)getFileset()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__ARG:
				return ((InternalEList<?>)getArg()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__ARG:
				return getArg();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__COMMAND:
				return getCommand();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__COMMANDLINE:
				return getCommandline();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__COMPRESSIONLEVEL:
				return getCompressionlevel();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__CVSFULLPATH:
				return getCvsfullpath();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__CVSROOT:
				return getCvsroot();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__CVSRSH:
				return getCvsrsh();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__DESTINATION:
				return getDestination();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__FAILONERROR:
				return getFailonerror();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__IF:
				return getIf();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__MODULE:
				return getModule();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__PASSFILE:
				return getPassfile();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__PASSWORD:
				return getPassword();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__QUIET:
				return getQuiet();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__READONLY:
				return getReadonly();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__READWRITE:
				return getReadwrite();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__REALLYQUIET:
				return getReallyquiet();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__TIMEOUT:
				return getTimeout();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__UNLESS:
				return getUnless();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__USESHARPCVSLIB:
				return getUsesharpcvslib();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__VERBOSE:
				return getVerbose();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_CVS_TASK__ANY_ATTRIBUTE:
...
} //NAntSourceControlTasksCvsTaskImpl
