...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>NAnt Core Tasks Copy Task</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getFileset <em>Fileset</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getFilterchain <em>Filterchain</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getFailonerror <em>Failonerror</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getFile <em>File</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getFlatten <em>Flatten</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getIf <em>If</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getIncludeemptydirs <em>Includeemptydirs</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getInputencoding <em>Inputencoding</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getOutputencoding <em>Outputencoding</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getOverwrite <em>Overwrite</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getTodir <em>Todir</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getTofile <em>Tofile</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getUnless <em>Unless</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getVerbose <em>Verbose</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTasksCopyTaskImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NAntCoreTasksCopyTaskImpl extends EObjectImpl implements NAntCoreTasksCopyTask {
	/**
	 ...
	 * @generated
	 */
	protected NAntCoreTasksCopyTaskImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return NantPackage.eINSTANCE.getNAntCoreTasksCopyTask();
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, NantPackage.NANT_CORE_TASKS_COPY_TASK__GROUP);
		}
		return group;
	}
	...
	public EList<NAntCoreTypesFileSet> getFileset() {
		return getGroup().list(NantPackage.eINSTANCE.getNAntCoreTasksCopyTask_Fileset());
	}
	...
	public EList<NAntCoreFiltersFilterChain> getFilterchain() {
		return getGroup().list(NantPackage.eINSTANCE.getNAntCoreTasksCopyTask_Filterchain());
	}
	...
	public void setFailonerror(Object newFailonerror) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TASKS_COPY_TASK__FAILONERROR, oldFailonerror, failonerror));
	}
	...
	public void setFile(Object newFile) {
		...
		file = newFile;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TASKS_COPY_TASK__FILE, oldFile, file));
	}
	...
	public void setFlatten(Object newFlatten) {
		...
		flatten = newFlatten;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TASKS_COPY_TASK__FLATTEN, oldFlatten, flatten));
	}
	...
	public void setIf(Object newIf) {
		...
		if_ = newIf;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TASKS_COPY_TASK__IF, oldIf, if_));
	}
	...
	public void setIncludeemptydirs(Object newIncludeemptydirs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TASKS_COPY_TASK__INCLUDEEMPTYDIRS, oldIncludeemptydirs, includeemptydirs));
	}
	...
	public void setInputencoding(Object newInputencoding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TASKS_COPY_TASK__INPUTENCODING, oldInputencoding, inputencoding));
	}
	...
	public void setOutputencoding(Object newOutputencoding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TASKS_COPY_TASK__OUTPUTENCODING, oldOutputencoding, outputencoding));
	}
	...
	public void setOverwrite(Object newOverwrite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TASKS_COPY_TASK__OVERWRITE, oldOverwrite, overwrite));
	}
	...
	public void setTodir(Object newTodir) {
		...
		todir = newTodir;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TASKS_COPY_TASK__TODIR, oldTodir, todir));
	}
	...
	public void setTofile(Object newTofile) {
		...
		tofile = newTofile;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TASKS_COPY_TASK__TOFILE, oldTofile, tofile));
	}
	...
	public void setUnless(Object newUnless) {
		...
		unless = newUnless;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TASKS_COPY_TASK__UNLESS, oldUnless, unless));
	}
	...
	public void setVerbose(Object newVerbose) {
		...
		verbose = newVerbose;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TASKS_COPY_TASK__VERBOSE, oldVerbose, verbose));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, NantPackage.NANT_CORE_TASKS_COPY_TASK__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__FILESET:
				return ((InternalEList<?>)getFileset()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__FILTERCHAIN:
				return ((InternalEList<?>)getFilterchain()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__FAILONERROR:
				return getFailonerror();
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__FILE:
				return getFile();
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__FLATTEN:
				return getFlatten();
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__IF:
				return getIf();
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__INCLUDEEMPTYDIRS:
				return getIncludeemptydirs();
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__INPUTENCODING:
				return getInputencoding();
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__OUTPUTENCODING:
				return getOutputencoding();
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__OVERWRITE:
				return getOverwrite();
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__TODIR:
				return getTodir();
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__TOFILE:
				return getTofile();
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__UNLESS:
				return getUnless();
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__VERBOSE:
				return getVerbose();
			case NantPackage.NANT_CORE_TASKS_COPY_TASK__ANY_ATTRIBUTE:
