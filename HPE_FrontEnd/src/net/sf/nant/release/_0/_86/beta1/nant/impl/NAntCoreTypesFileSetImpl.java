...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>NAnt Core Types File Set</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getPatternset <em>Patternset</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getIncludes <em>Includes</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getInclude <em>Include</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getExcludes <em>Excludes</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getExclude <em>Exclude</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getIncludesList <em>Includes List</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getIncludesfile <em>Includesfile</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getExcludesfile <em>Excludesfile</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getBasedir <em>Basedir</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getCasesensitive <em>Casesensitive</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getDefaultexcludes <em>Defaultexcludes</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getFailonempty <em>Failonempty</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getId <em>Id</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getRefid <em>Refid</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntCoreTypesFileSetImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NAntCoreTypesFileSetImpl extends EObjectImpl implements NAntCoreTypesFileSet {
	/**
	 ...
	 * @generated
	 */
	protected NAntCoreTypesFileSetImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return NantPackage.eINSTANCE.getNAntCoreTypesFileSet();
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, NantPackage.NANT_CORE_TYPES_FILE_SET__GROUP);
		}
		return group;
	}
	...
	public EList<NAntCoreTypesPatternSet> getPatternset() {
		return getGroup().list(NantPackage.eINSTANCE.getNAntCoreTypesFileSet_Patternset());
	}
	...
	public EList<NAntCoreTypesFileSetInclude> getIncludes() {
		return getGroup().list(NantPackage.eINSTANCE.getNAntCoreTypesFileSet_Includes());
	}
	...
	public EList<NAntCoreTypesFileSetInclude> getInclude() {
		return getGroup().list(NantPackage.eINSTANCE.getNAntCoreTypesFileSet_Include());
	}
	...
	public EList<NAntCoreTypesFileSetExclude> getExcludes() {
		return getGroup().list(NantPackage.eINSTANCE.getNAntCoreTypesFileSet_Excludes());
	}
	...
	public EList<NAntCoreTypesFileSetExclude> getExclude() {
		return getGroup().list(NantPackage.eINSTANCE.getNAntCoreTypesFileSet_Exclude());
	}
	...
	public EList<NAntCoreTypesFileSetIncludesFile> getIncludesList() {
		return getGroup().list(NantPackage.eINSTANCE.getNAntCoreTypesFileSet_IncludesList());
	}
	...
	public EList<NAntCoreTypesFileSetIncludesFile> getIncludesfile() {
		return getGroup().list(NantPackage.eINSTANCE.getNAntCoreTypesFileSet_Includesfile());
	}
	...
	public EList<NAntCoreTypesFileSetExcludesFile> getExcludesfile() {
		return getGroup().list(NantPackage.eINSTANCE.getNAntCoreTypesFileSet_Excludesfile());
	}
	...
	public void setBasedir(Object newBasedir) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TYPES_FILE_SET__BASEDIR, oldBasedir, basedir));
	}
	...
	public void setCasesensitive(Object newCasesensitive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TYPES_FILE_SET__CASESENSITIVE, oldCasesensitive, casesensitive));
	}
	...
	public void setDefaultexcludes(Object newDefaultexcludes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TYPES_FILE_SET__DEFAULTEXCLUDES, oldDefaultexcludes, defaultexcludes));
	}
	...
	public void setFailonempty(Object newFailonempty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TYPES_FILE_SET__FAILONEMPTY, oldFailonempty, failonempty));
	}
	...
	public void setId(Object newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TYPES_FILE_SET__ID, oldId, id));
	}
	...
	public void setRefid(Object newRefid) {
		...
		refid = newRefid;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_CORE_TYPES_FILE_SET__REFID, oldRefid, refid));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, NantPackage.NANT_CORE_TYPES_FILE_SET__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NantPackage.NANT_CORE_TYPES_FILE_SET__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_CORE_TYPES_FILE_SET__PATTERNSET:
				return ((InternalEList<?>)getPatternset()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_CORE_TYPES_FILE_SET__INCLUDES:
				return ((InternalEList<?>)getIncludes()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_CORE_TYPES_FILE_SET__INCLUDE:
				return ((InternalEList<?>)getInclude()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_CORE_TYPES_FILE_SET__EXCLUDES:
				return ((InternalEList<?>)getExcludes()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_CORE_TYPES_FILE_SET__EXCLUDE:
				return ((InternalEList<?>)getExclude()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_CORE_TYPES_FILE_SET__INCLUDES_LIST:
				return ((InternalEList<?>)getIncludesList()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_CORE_TYPES_FILE_SET__INCLUDESFILE:
				return ((InternalEList<?>)getIncludesfile()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_CORE_TYPES_FILE_SET__EXCLUDESFILE:
				return ((InternalEList<?>)getExcludesfile()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_CORE_TYPES_FILE_SET__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case NantPackage.NANT_CORE_TYPES_FILE_SET__BASEDIR:
				return getBasedir();
			case NantPackage.NANT_CORE_TYPES_FILE_SET__CASESENSITIVE:
				return getCasesensitive();
			case NantPackage.NANT_CORE_TYPES_FILE_SET__DEFAULTEXCLUDES:
				return getDefaultexcludes();
			case NantPackage.NANT_CORE_TYPES_FILE_SET__FAILONEMPTY:
				return getFailonempty();
			case NantPackage.NANT_CORE_TYPES_FILE_SET__ID:
				return getId();
			case NantPackage.NANT_CORE_TYPES_FILE_SET__REFID:
				return getRefid();
			case NantPackage.NANT_CORE_TYPES_FILE_SET__ANY_ATTRIBUTE:
