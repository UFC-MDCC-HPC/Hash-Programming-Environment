...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>NAnt Source Control Tasks RTag Task</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getFileset <em>Fileset</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getArg <em>Arg</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getActOnDate <em>Act On Date</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getActOnTag <em>Act On Tag</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getCommandline <em>Commandline</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getCompressionlevel <em>Compressionlevel</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getCvsfullpath <em>Cvsfullpath</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getCvsroot <em>Cvsroot</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getCvsrsh <em>Cvsrsh</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getFailonerror <em>Failonerror</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getForceHead <em>Force Head</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getIf <em>If</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getModule <em>Module</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getMoveIfExists <em>Move If Exists</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getPassfile <em>Passfile</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getQuiet <em>Quiet</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getReadonly <em>Readonly</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getReadwrite <em>Readwrite</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getReallyquiet <em>Reallyquiet</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getRecursive <em>Recursive</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getRemove <em>Remove</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getTag <em>Tag</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getTimeout <em>Timeout</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getUnless <em>Unless</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getUsesharpcvslib <em>Usesharpcvslib</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getVerbose <em>Verbose</em>}</li>
 *   <li>{@link net.sf.nant.release._0._86.beta1.nant.impl.NAntSourceControlTasksRTagTaskImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NAntSourceControlTasksRTagTaskImpl extends EObjectImpl implements NAntSourceControlTasksRTagTask {
	/**
	 ...
	 * @generated
	 */
	protected NAntSourceControlTasksRTagTaskImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return NantPackage.eINSTANCE.getNAntSourceControlTasksRTagTask();
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__GROUP);
		}
		return group;
	}
	...
	public EList<NAntSourceControlTypesCvsFileSet> getFileset() {
		return getGroup().list(NantPackage.eINSTANCE.getNAntSourceControlTasksRTagTask_Fileset());
	}
	...
	public EList<NAntCoreTypesArgument> getArg() {
		return getGroup().list(NantPackage.eINSTANCE.getNAntSourceControlTasksRTagTask_Arg());
	}
	...
	public void setActOnDate(Object newActOnDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__ACT_ON_DATE, oldActOnDate, actOnDate));
	}
	...
	public void setActOnTag(Object newActOnTag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__ACT_ON_TAG, oldActOnTag, actOnTag));
	}
	...
	public void setCommandline(Object newCommandline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__COMMANDLINE, oldCommandline, commandline));
	}
	...
	public void setCompressionlevel(Object newCompressionlevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__COMPRESSIONLEVEL, oldCompressionlevel, compressionlevel));
	}
	...
	public void setCvsfullpath(Object newCvsfullpath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__CVSFULLPATH, oldCvsfullpath, cvsfullpath));
	}
	...
	public void setCvsroot(Object newCvsroot) {
		...
		cvsroot = newCvsroot;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__CVSROOT, oldCvsroot, cvsroot));
	}
	...
	public void setCvsrsh(Object newCvsrsh) {
		...
		cvsrsh = newCvsrsh;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__CVSRSH, oldCvsrsh, cvsrsh));
	}
	...
	public void setDestination(Object newDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__DESTINATION, oldDestination, destination));
	}
	...
	public void setFailonerror(Object newFailonerror) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__FAILONERROR, oldFailonerror, failonerror));
	}
	...
	public void setForceHead(Object newForceHead) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__FORCE_HEAD, oldForceHead, forceHead));
	}
	...
	public void setIf(Object newIf) {
		...
		if_ = newIf;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__IF, oldIf, if_));
	}
	...
	public void setModule(Object newModule) {
		...
		module = newModule;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__MODULE, oldModule, module));
	}
	...
	public void setMoveIfExists(Object newMoveIfExists) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__MOVE_IF_EXISTS, oldMoveIfExists, moveIfExists));
	}
	...
	public void setPassfile(Object newPassfile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__PASSFILE, oldPassfile, passfile));
	}
	...
	public void setPassword(Object newPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__PASSWORD, oldPassword, password));
	}
	...
	public void setQuiet(Object newQuiet) {
		...
		quiet = newQuiet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__QUIET, oldQuiet, quiet));
	}
	...
	public void setReadonly(Object newReadonly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__READONLY, oldReadonly, readonly));
	}
	...
	public void setReadwrite(Object newReadwrite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__READWRITE, oldReadwrite, readwrite));
	}
	...
	public void setReallyquiet(Object newReallyquiet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__REALLYQUIET, oldReallyquiet, reallyquiet));
	}
	...
	public void setRecursive(Object newRecursive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__RECURSIVE, oldRecursive, recursive));
	}
	...
	public void setRemove(Object newRemove) {
		...
		remove = newRemove;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__REMOVE, oldRemove, remove));
	}
	...
	public void setTag(Object newTag) {
		...
		tag = newTag;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__TAG, oldTag, tag));
	}
	...
	public void setTimeout(Object newTimeout) {
		...
		timeout = newTimeout;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__TIMEOUT, oldTimeout, timeout));
	}
	...
	public void setUnless(Object newUnless) {
		...
		unless = newUnless;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__UNLESS, oldUnless, unless));
	}
	...
	public void setUsesharpcvslib(Object newUsesharpcvslib) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__USESHARPCVSLIB, oldUsesharpcvslib, usesharpcvslib));
	}
	...
	public void setVerbose(Object newVerbose) {
		...
		verbose = newVerbose;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__VERBOSE, oldVerbose, verbose));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__FILESET:
				return ((InternalEList<?>)getFileset()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__ARG:
				return ((InternalEList<?>)getArg()).basicRemove(otherEnd, msgs);
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__ARG:
				return getArg();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__ACT_ON_DATE:
				return getActOnDate();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__ACT_ON_TAG:
				return getActOnTag();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__COMMANDLINE:
				return getCommandline();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__COMPRESSIONLEVEL:
				return getCompressionlevel();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__CVSFULLPATH:
				return getCvsfullpath();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__CVSROOT:
				return getCvsroot();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__CVSRSH:
				return getCvsrsh();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__DESTINATION:
				return getDestination();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__FAILONERROR:
				return getFailonerror();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__FORCE_HEAD:
				return getForceHead();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__IF:
				return getIf();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__MODULE:
				return getModule();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__MOVE_IF_EXISTS:
				return getMoveIfExists();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__PASSFILE:
				return getPassfile();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__PASSWORD:
				return getPassword();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__QUIET:
				return getQuiet();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__READONLY:
				return getReadonly();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__READWRITE:
				return getReadwrite();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__REALLYQUIET:
				return getReallyquiet();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__RECURSIVE:
				return getRecursive();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__REMOVE:
				return getRemove();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__TAG:
				return getTag();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__TIMEOUT:
				return getTimeout();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__UNLESS:
				return getUnless();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__USESHARPCVSLIB:
				return getUsesharpcvslib();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__VERBOSE:
				return getVerbose();
			case NantPackage.NANT_SOURCE_CONTROL_TASKS_RTAG_TASK__ANY_ATTRIBUTE:
...
} //NAntSourceControlTasksRTagTaskImpl
