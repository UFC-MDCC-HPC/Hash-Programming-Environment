...
public class HPlatformUnit extends HQualifierUnit implements IHQualifierUnit {

	static final long serialVersionUID = 1;
	
	public HPlatformUnit(String name, HComponent configuration,
	...
	protected HInterface newInterface(HComponent c, HInterfaceSig s,
		...
		return new HPlatformInterface(c,s,unit,l);	
	}

	public HUnitSlice newSlice(IHUnit the_unit, Point where) throws HPEAbortException{
		return new HPlatformUnitSlice(the_unit, this, where);
	}
