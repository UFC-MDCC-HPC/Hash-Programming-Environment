...
import hPE.frontend.base.interfaces.IActionCombinatorAlt;

public class HAltAction extends hPE.frontend.kinds.activate.model.protocol.HCombinatorAction  implements Serializable, IActionCombinatorAlt {

	static final long serialVersionUID = 1;
	
	/**
	 */
	public HAltAction(String label) {
		super(label);
	}

	public HAltAction(String label, HProtocol protocol) {
		super(label, protocol);
	}

	/**
	 */
	public HAltAction(String label, HCombinatorAction action_combinator) {
