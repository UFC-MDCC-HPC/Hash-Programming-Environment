...
public class LocationsFactoryImpl extends EFactoryImpl implements LocationsFactory {
	...
	public static LocationsFactory init() {
		try {
			LocationsFactory theLocationsFactory = (LocationsFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.example.org/BackEndLocations"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case LocationsPackage.LOCATION: return createLocation();
			case LocationsPackage.SERVICES: return createServices();
			default:
