 ...
 *   <li>{@link hPE.frontend.backend.locations.impl.LocationImpl#getUri <em>Uri</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LocationImpl extends EObjectImpl implements Location {
	...
	protected EClass eStaticClass() {
		return LocationsPackage.Literals.LOCATION;
	}
	...
	public void setLogin(String newLogin) {
		...
		login = newLogin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LocationsPackage.LOCATION__LOGIN, oldLogin, login));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LocationsPackage.LOCATION__NAME, oldName, name));
	}
	...
	public void setPassword(String newPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LocationsPackage.LOCATION__PASSWORD, oldPassword, password));
	}
	...
	public void setUri(String newUri) {
		...
		uri = newUri;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LocationsPackage.LOCATION__URI, oldUri, uri));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case LocationsPackage.LOCATION__NAME:
				return getName();
			case LocationsPackage.LOCATION__PASSWORD:
				return getPassword();
			case LocationsPackage.LOCATION__URI:
				return getUri();
		}
