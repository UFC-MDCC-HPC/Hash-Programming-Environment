 ...
 * <ul>
 *   <li>{@link hPE.frontend.backend.locations.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link hPE.frontend.backend.locations.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link hPE.frontend.backend.locations.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link hPE.frontend.backend.locations.impl.DocumentRootImpl#getServices <em>Services</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
	...
	public Services getServices() {
		return (Services)getMixed().get(LocationsPackage.Literals.DOCUMENT_ROOT__SERVICES, true);
	}
	...
	public NotificationChain basicSetServices(Services newServices, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(LocationsPackage.Literals.DOCUMENT_ROOT__SERVICES, newServices, msgs);
	}
	...
	public void setServices(Services newServices) {
		((FeatureMap.Internal)getMixed()).set(LocationsPackage.Literals.DOCUMENT_ROOT__SERVICES, newServices);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case LocationsPackage.DOCUMENT_ROOT__SERVICES:
