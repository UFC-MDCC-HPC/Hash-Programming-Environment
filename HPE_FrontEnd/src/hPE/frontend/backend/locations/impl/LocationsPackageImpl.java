...
public class LocationsPackageImpl extends EPackageImpl implements LocationsPackage {
	 ...
	 * @see hPE.frontend.backend.locations.LocationsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private LocationsPackageImpl() {
		super(eNS_URI, LocationsFactory.eINSTANCE);
	}
	...
	public static LocationsPackage init() {
		if (isInited) return (LocationsPackage)EPackage.Registry.INSTANCE.getEPackage(LocationsPackage.eNS_URI);

		// Obtain or create and register package
		LocationsPackageImpl theLocationsPackage = (LocationsPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof LocationsPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new LocationsPackageImpl());
		...
		theLocationsPackage.createPackageContents();

		// Initialize created meta-data
		theLocationsPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theLocationsPackage.freeze();

		return theLocationsPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getServices_Backend() {
	...
	public void createPackageContents() {
		...
		createEReference(servicesEClass, SERVICES__BACKEND);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getLocation_Uri(), theXMLTypePackage.getAnyURI(), "uri", null, 0, 1, Location.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(servicesEClass, Services.class, "Services", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getServices_Backend(), this.getLocation(), null, "backend", null, 0, -1, Services.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
