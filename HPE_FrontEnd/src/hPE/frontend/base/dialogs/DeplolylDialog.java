...
import hPE.frontend.base.codegen.C.HBESynthesizerDataTypeRawForC;
...
public class DeplolylDialog extends JDialog {
	 ...
	 * @param onlyEdit TODO
	 */
	public DeplolylDialog(HInterface i, boolean onlyEdit) {
		super();
		this.i = i;
		this.editor = editor;		
		initialize(onlyEdit);
