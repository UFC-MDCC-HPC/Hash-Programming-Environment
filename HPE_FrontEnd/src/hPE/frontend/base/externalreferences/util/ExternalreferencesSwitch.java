 ...
 * @generated
 */
public class ExternalreferencesSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	public ExternalreferencesSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExternalreferencesPackage.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExternalreferencesPackage.REFERENCE_LIST_TYPE: {
				ReferenceListType referenceListType = (ReferenceListType)theEObject;
				T result = caseReferenceListType(referenceListType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExternalreferencesPackage.REFERENCE_TYPE: {
