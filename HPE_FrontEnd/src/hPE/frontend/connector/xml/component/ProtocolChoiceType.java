 ...
 * <ul>
 *   <li>{@link hPE.frontend.connector.xml.component.ProtocolChoiceType#getPar <em>Par</em>}</li>
 *   <li>{@link hPE.frontend.connector.xml.component.ProtocolChoiceType#getSeq <em>Seq</em>}</li>
 *   <li>{@link hPE.frontend.connector.xml.component.ProtocolChoiceType#getAlt <em>Alt</em>}</li>
 *   <li>{@link hPE.frontend.connector.xml.component.ProtocolChoiceType#getPerform <em>Perform</em>}</li>
 * </ul>
 * </p>
 *
 * @see hPE.frontend.connector.xml.component.ComponentPackage#getProtocolChoiceType()
...
public interface ProtocolChoiceType extends EObject {
	 ...
	 * @see hPE.frontend.connector.xml.component.ComponentPackage#getProtocolChoiceType_Par()
	...
	/**
	 * Sets the value of the '{@link hPE.frontend.connector.xml.component.ProtocolChoiceType#getPar <em>Par</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see hPE.frontend.connector.xml.component.ComponentPackage#getProtocolChoiceType_Seq()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link hPE.frontend.connector.xml.component.ProtocolChoiceType#getSeq <em>Seq</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see hPE.frontend.connector.xml.component.ComponentPackage#getProtocolChoiceType_Alt()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link hPE.frontend.connector.xml.component.ProtocolChoiceType#getAlt <em>Alt</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Perform</em>' containment reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Perform</em>' containment reference.
	 * @see #setPerform(ProtocolPerformType)
	 * @see hPE.frontend.connector.xml.component.ComponentPackage#getProtocolChoiceType_Perform()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link hPE.frontend.connector.xml.component.ProtocolChoiceType#getPerform <em>Perform</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
