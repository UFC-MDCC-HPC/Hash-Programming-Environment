...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Hpekind</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see hPE.frontend.connector.xml.component.ComponentPackage#getHpekind()
 * @model extendedMetaData="name='hpekind'"
 * @generated
 */
public enum Hpekind implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Hpekind</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final Hpekind[] VALUES_ARRAY =
		new Hpekind[] {
			DATA,
			COMPUTATION,
			SYNCHRONIZER,
	...
	/**
	 * A public read-only list of all the '<em><b>Hpekind</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<Hpekind> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Hpekind</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static Hpekind get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Hpekind result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Hpekind</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static Hpekind getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Hpekind result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Hpekind</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static Hpekind get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private Hpekind(int value, String name, String literal) {
		this.value = value;
		this.name = name;
