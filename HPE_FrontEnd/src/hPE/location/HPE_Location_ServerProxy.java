...
public class HPE_Location_ServerProxy implements hPE.location.HPE_Location_Server {
  private String _endpoint = null;
  private hPE.location.HPE_Location_Server hPE_Location_Server = null;
  ...
  private void _initHPE_Location_ServerProxy() {
    try {
      hPE_Location_Server = (new hPE.location.HPE_Location_ServerServiceLocator()).getHPE_Location_Server();
  ...
  public hPE.location.HPE_Location_Server getHPE_Location_Server() {
    if (hPE_Location_Server == null)
      _initHPE_Location_ServerProxy();
