...
public class HBESynthesizerCSharpConcrete extends hPE.backend.cluster.synthesizer.base.c_sharp.HBESynthesizerCSharpConcrete {
	...
	public HBESourceVersionCSharp synthesize(HInterface i, String versionID) {
	    ...
	    hPE.backend.cluster.synthesizer.syntaxtree.HBESyntaxTree p2p = new hPE.backend.cluster.synthesizer.syntaxtree.HBESyntaxTree((HActivateInterface)i);
	    this.p2p = p2p;
