...
import hPE.backend.cluster.synthesizer.*;
import hPE.backend.cluster.synthesizer.syntaxtree.*;
...
public class HBESynthesizerForC extends HBEAbstractSynthesizer<HBECSource,HBESourceVersionForC,HActivateInterface> {
	...
	public HBESourceVersionForC synthesize(HActivateInterface i, String versionID) {
	    ...
	    hPE.backend.cluster.synthesizer.syntaxtree.HBESyntaxTree p2p = new hPE.backend.cluster.synthesizer.syntaxtree.HBESyntaxTree(i);
	    this.p2p = p2p;
