...
public class hPEEditorContextMenuProvider extends ContextMenuProvider {
	...
	public hPEEditorContextMenuProvider(EditPartViewer viewer, ActionRegistry registry, HComponent configuration) {
		super(viewer);
	...
	public void buildContextMenu(IMenuManager menu) {
		...
		for (SelectionAction action : kindsActions) {
			IAction iAction = getAction(action.getId());
			if (iAction != null && iAction.isEnabled())	{
				menu.appendToGroup(GEFActionConstants.GROUP_REST, iAction);
			}
		}
