 ...
 * <ul>
 *   <li>{@link hPE.xml.component.impl.ImplementsTypeImpl#getCRef <em>CRef</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ImplementsTypeImpl extends MinimalEObjectImpl.Container implements ImplementsType {
	/**
	...
	protected EClass eStaticClass() {
		return ComponentPackage.Literals.IMPLEMENTS_TYPE;
	}
	...
	public void setCRef(String newCRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.IMPLEMENTS_TYPE__CREF, oldCRef, cRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ComponentPackage.IMPLEMENTS_TYPE__CREF:
				return getCRef();
		}
