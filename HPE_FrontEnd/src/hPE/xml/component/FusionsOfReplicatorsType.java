 ...
 * <ul>
 *   <li>{@link hPE.xml.component.FusionsOfReplicatorsType#getFusionOfReplicators <em>Fusion Of Replicators</em>}</li>
 * </ul>
 * </p>
 *
 * @see hPE.xml.component.ComponentPackage#getFusionsOfReplicatorsType()
...
public interface FusionsOfReplicatorsType extends EObject {
	 ...
	 * The list contents are of type {@link hPE.xml.component.FusionOfReplicatorsType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see hPE.xml.component.ComponentPackage#getFusionsOfReplicatorsType_FusionOfReplicators()
