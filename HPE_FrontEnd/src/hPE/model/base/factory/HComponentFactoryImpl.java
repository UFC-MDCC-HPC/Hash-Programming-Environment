...
import hPE.model.base.HPackageLocation;
...
import hPE.model.protocol.kinds.activate.HPrimitiveAction;
import hPE.model.protocol.kinds.activate.HProtocol;
import hPE.model.protocol.kinds.activate.HSemaphore;
import hPE.model.protocol.kinds.activate.HSeqAction;
import hPE.model.protocol.kinds.activate.HSignalAction;
import hPE.model.protocol.kinds.activate.HSkipAction;
import hPE.model.protocol.kinds.activate.HWaitAction;
	...
	public HComponent buildComponent(ComponentType xC, URI uri){
		...
		try {
			...
			if (xCinfo != null) {
	            ...
	            loadSplits(xCinfo);                       // loadSplits pode ser antes de loadEnumerators uma vez que o split é feito com um replicador herdado de um componente interno.
//ggg
	...
	private void loadSlices(UnitType xU, HUnit u) throws HPEInvalidComponentResourceException{
		...
		//			check.add(cRef + uRef);
					...
					if (mC1.containsKey(cRef)) {
						...
						// significa que a fatia é de um componente do super tipo
					}
				}
			}
		}
