...
public class HPEVersionEditor extends MultiPageEditorPart implements
	...
	/*
	 * public String getTitle() { int i = this.getActivePage(); if
	 * (this.getPageCount() > 0) return getEditor(i).getTitle(); else return
	 * "Loading Component";
	 * 
	 * 
	 * 
