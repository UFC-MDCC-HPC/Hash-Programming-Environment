...
namespace br.ufc.pargo.hpe.connector.monitoring
{
	public class Monitor : IMonitor
	{
		...
		public void Started (int state, int transation, int actionId)
		{
			...
			//Console.WriteLine ("[Monitor.Started] state:{0} | transation:{1} | actionId:{2}", state, transation, actionId);
		...
		public void Finalized (int state, int transation, int actionId)
		{
			...
			//Console.WriteLine ("[Monitor.Finalized] state:{0} | transation:{1} | actionId:{2}", state, transation, actionId);
