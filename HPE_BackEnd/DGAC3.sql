...
CREATE TABLE `slice` (
  ...
  PRIMARY KEY (`id_abstract`,`id_inner`,`id_interface_slice`,`id_interface`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `supplyparameterparameter` (
  `id_parameter` varchar(45) NOT NULL,
  `id_functor_app` int(11) NOT NULL,
  `id_parameter_actual` varchar(45) NOT NULL,
...
CREATE TABLE `unit` (
  ...
  PRIMARY KEY (`id_concrete`,`id_unit`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
