...
namespace br.ufc.mdcc.hpcshelf.core
{
	...
	public class CoreServicesUtils
	{
		...
		public static SAFeSWL_Architecture readArchitecture (string arch_desc_xml)
		{
			...
			SAFeSWL_Architecture arch_desc = CoreServicesUtils.DeserializeArchitecture_SAFeSWL(filename);
			return arch_desc;
		}
...
*/
			                                      ...
			                                      object platform_address)
		{
			...
			if (platform_address is string)
			{
				...
				CoreCacheServices.PlatformServices.PlatformServices platform_access_ = new CoreCacheServices.PlatformServices.PlatformServices ((string)platform_address);
