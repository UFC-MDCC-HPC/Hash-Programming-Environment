...
namespace impl.bt.solve.YUnpackBackSubInfoImpl { 
	public class IYUnpackBackSubInfoImpl<I, C, DIR, MTH> : BaseIYUnpackBackSubInfoImpl<I, C, DIR, MTH>, IPackUnpack<I, C, DIR, MTH>
	...
	where MTH:IBeamWarmingMethod {
		...
		public IYUnpackBackSubInfoImpl() { 
