...
namespace impl.bt.solve.YUnpackSolveInfoImpl { 
	public class IYUnpackSolveInfoImpl<I, C, DIR, MTH> : BaseIYUnpackSolveInfoImpl<I, C, DIR, MTH>, IPackUnpack<I, C, DIR, MTH>
