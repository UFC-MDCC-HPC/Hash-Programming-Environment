...
namespace impl.bt.solve.YPackSolveInfoImpl { 
	public class IYPackSolveInfoImpl<I, C, DIR, MTH> : BaseIYPackSolveInfoImpl<I, C, DIR, MTH>, IPackUnpack<I, C, DIR, MTH>
